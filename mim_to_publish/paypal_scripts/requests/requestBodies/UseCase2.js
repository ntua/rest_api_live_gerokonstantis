export const createProductReqBody = (date, number) => {
  return {
    name: `My Product ${number}`,
    type: "PHYSICAL",
    id: `${date}`,
    description: `Product's description ${number}`,
    category: "CLOTHING",
...
export const fullyUpdateInvoiceReqBody = (date) => {
  return {
    detail: {
      invoice_number: `${date}`,
      invoice_date: "2024-05-22",
    ...
    items: [
      {
        name: "My Product 4",
        description: "Product's description 4",
        quantity: "1",
        unit_amount: {
          currency_code: "USD",
          value: "120.00",
      ...
      {
        name: "My Product 3",
        description: "Product's description 3",
        quantity: "1",
        unit_amount: {
          currency_code: "USD",
          value: "80.00",
...
export const cancelSentInvoiceReqBody = () => {
  return {
    subject:
      "<The subject of the email that is sent as a notification to the recipient.>",
    note: "<A note to the payer.>",
    ...
    send_to_recipient: true,
    additional_recipients: ["user_in_cc@example.com"],
  };
};
