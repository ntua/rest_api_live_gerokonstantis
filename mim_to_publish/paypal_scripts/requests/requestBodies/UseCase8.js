export const createInvoiceTemplateReqBody = (date) => {
  return {
    name: `template_${date}`,
    ...
    template_info: {
      ...
      invoicer: {
        ...
        email_address: "sb-oduor30366001@business.example.com",
        phones: [
          {
            country_code: "001",
      ...
      additional_recipients: ["inform-me@example.com"],
      items: [
        {
          name: "My Product 1",
...
export const fullyUpdateInvTemplateReqBody = (date) => {
  return {
    name: `template_${date}`,
    default_template: true,
    template_info: {
